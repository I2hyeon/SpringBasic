...
//					)
	...
	public Object arroundLog(ProceedingJoinPoint jp) {
		...
		/*
		 * 메서드로 넘어오는 매개변수 확인가능 메서드 실행되는 target확인가능 이런결과를 수집해서, 전체 log로 찍어주거나 FileOutput을
		 * 이용해서 실행로그 출력을 해줄 수있음.
		 * 
		 */
		...
		try {
			...
			String path = "C:\\Users\\user\\Desktop\\course\\spring_log\\오늘날짜_log.txt";
